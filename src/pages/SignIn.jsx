  ...
  border-yellow-500'
    >
      <div className='bg-slate-700 w-full h-screen mb-12 flex items-center justify-center'>
        <div className='w-full h-4/4 mb-20 sm:w-2/3 sm:h-2/3 md:w-2/3 md:h-2/3 lg:w-3/4 lg:h-3/4 xl:w-4/5 xl:h-3/5 xl:rounded bg-slate-700 overflow-hidden flex items-center justify-center shadow-2xl mt-[-61px] md:mt-0'>
          <img
      ...
      <div className='bg-opacity-80 md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/3 h-full md:h-screen px-6 lg:px-12 xl:px-12 flex items-center justify-center bg-slate-700 p-5 text-center w-full'>
        <div className='w-full  xl:mr-10 xl:mb-16 mt-[-100px]'>
          ...
          <form onSubmit={onSubmit} className='mt-2'>
            ...
            <div className='text-sm text-blue-400 hover:text-yellow-500 font-semibold flex justify-end items-start mb-4'>
              <p>
            ...
            <button
              type='submit'
              className='py-3 text-sm font-serif before:ease w-full overflow-hidden border border-yellow-500 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 focus:ring-offset-slate-50 bg-slate-600 text-yellow-500 shadow-md transition-all before:absolute before:right-0 before:top-0 before:h-10 before:w-4 before:translate-x-6 before:rotate-6 before:bg-yellow-500 before:opacity-10 before:duration-700 hover:shadow-yellow-500 rounded'
            >
              Sign In
            </button>
          </form>
